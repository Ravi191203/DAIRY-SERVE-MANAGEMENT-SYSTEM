...
<head>
  ...
  <link href="assets/fontawesome-free-6.5.2-web/css/solid.css" rel="stylesheet" />
        ...
        .banner-area {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url('images/images.jpeg');
            height: 650px;
...
<body class="main-body">
    <header class="bg-light py-3">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a href="logout.php" class="btn btn-outline-success"><i class="fa-solid fa-right-from-bracket" style="color: #f60909;"></i> Logout</a>
        </div>
    </header>
    ...
    <footer class="bg-dark text-white py-4">
        <div class="container">
            ...
            <div class="text-center mt-3">
                ...
                <a href="https://www.instagram.com/?hl=en"><i class="fa-brands fa-instagram fa-2x mx-2 fa-flip" style="color: white;"></i></a>
                <a href="https://www.facebook.com" ><i class="fa-brands fa-facebook fa-2x mx-2 fa-flip" style="color: white;"></i></a>
                <a href="https://www.twitter.com" ><i class="fa-brands fa-github fa-2x mx-2 fa-flip" style="color: white"></i></a>
                <a href="https://www.telegram.com"><i class="fa-brands fa-twitter fa-2x mx-2 fa-flip" style="color: white"></i></a>
                <a href="https://www.github.com"><i class="fa-brands fa-google fa-2x mx-2 fa-flip" style="color: white"></i></a>
                <a href="https://rrgs_dev.com"><i class="fa-brands fa-linkedin fa-2x mx-2 fa-flip" style="color: white"></i></a>
            </div>
        </div>
    </footer>
