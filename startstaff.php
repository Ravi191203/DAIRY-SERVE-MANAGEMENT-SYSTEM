...
<body class="main-body">
    <header class="bg-light py-3">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <span class="title text-secondary">Dairy Serve Management System</span>
            <a href="logout.php" class="btn btn-outline-danger"><i class="fas fa-sign-in-alt"></i> Logout</a>
        </div>
    </header>
    ...
    <footer class="bg-dark text-white py-4">
        <div class="container">
            ...
            <div class="text-center mt-3">
                <h4>Connect With</h4><br>
                <a href="https://www.instagram.com/?hl=en"><i class="fab fa-instagram fa-2x mx-2 fa-spin fa-spin-reverse" style="color: white;"></i></a>
                <a href="https://www.facebook.com" ><i class="fab fa-facebook fa-2x mx-2 fa-spin fa-spin-reverse" style="color: white;"></i></a>
                <a href="https://www.twitter.com" ><i class="fab fa-twitter fa-2x mx-2 fa-spin fa-spin-reverse" style="color: white;"></i></a>
                <a href="https://www.telegram.com"><i class="fab fa-telegram fa-2x mx-2 fa-spin fa-spin-reverse" style="color: white;"></i></a>
                <a href="https://www.github.com"><i class="fab fa-github fa-2x mx-2 fa-spin fa-spin-reverse" style="color: white;"></i></a>
                <a href="https://rrgs_dev.com"><i class="fab fa-google fa-2x mx-2 fa-spin fa-spin-reverse" style="color: white;"></i></a>
            </div>
        </div>
    </footer>
